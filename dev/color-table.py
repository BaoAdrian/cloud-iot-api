...
print("""<svg align="center" viewBox="0 0 60 55" preserveAspectRatio="xMidYMin slice"
...
# Red
print("""<button type="button" onclick="window.location.href = 'http://ec2-107-23-175-18.compute-1.amazonaws.com/cgi-bin/color-table.py?red=%s&green=%s&blue=%s&opacity=%s'" align="left"   style="height:200px; width:200px; background:rgb(255,0,0); font-size:24px;">Red</button>""" % (red_config[0], red_config[1], red_config[2], opacity))

# Green
print("""<button type="button" onclick="window.location.href = 'http://ec2-107-23-175-18.compute-1.amazonaws.com/cgi-bin/color-table.py?red=%s&green=%s&blue=%s&opacity=%s'" align="center" style="height:200px; width:200px; background:rgb(0,255,0); font-size:24px;">Green</button>""" % (green_config[0], green_config[1], green_config[2], opacity))

# Blue
print("""<button type="button" onclick="window.location.href = 'http://ec2-107-23-175-18.compute-1.amazonaws.com/cgi-bin/color-table.py?red=%s&green=%s&blue=%s&opacity=%s'" align="right"  style="height:200px; width:200px; background:rgb(0,0,255); font-size:24px;">Blue</button>
		</p>""" % (blue_config[0], blue_config[1], blue_config[2], opacity))
