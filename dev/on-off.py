...
<center/>
                <p align="center">
                        <button type="button" align="center" onclick="window.location.href = 'http://ec2-107-23-175-18.compute-1.amazonaws.com/cgi-bin/on-off.py?status=0'" style="height:150px; width:150px; background:rgb(220,20,60); font-size:24px;">Turn OFF</button>
                </p>
                </body></html>
                """)
else:
...
<center/>
                <p align="center">
                        <button type="button" align="center" onclick="window.location.href = 'http://ec2-107-23-175-18.compute-1.amazonaws.com/cgi-bin/on-off.py?status=1'" style="height:150px; width:150px; background:rgb(60,220,60); font-size:24px;">Turn ON</button>
                </p>
                </body></html>
                """)
