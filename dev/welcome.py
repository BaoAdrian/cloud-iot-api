...
print("""<body>
		...
		<p align="center">
			<button type="button" align="right" onclick="window.location.href = 'http://%s/cgi-bin/house-simulator.py';" style="height:175px; width:250px; background:rgb(220,170,200); font-size:30px;">House Simulator</button>
		</p>
